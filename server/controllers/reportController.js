...
export const getSalesReport = async (req, res) => {
  try {
    const reportType = req.query.type || "today";
...
export const getPurchaseReport = async (
  ...
  try {
    const result =
      await getPurchaseReportService();
...
export const getLowStockReport = async (
  ...
  try {
    const result =
      await getLowStockReportService();
...
export const getExpiredMedicinesReport =
  async (req, res) => {
    try {
      const result =
        await getExpiredMedicinesReportService();
...
export const getWeeklySalesReport =
  async (req, res) => {
    try {
      const result =
        await getWeeklySalesReportService();
...
export const getMonthlySalesReport =
  async (req, res) => {
    try {
      const result =
        await getMonthlySalesReportService();
...
export const getBestSellingMedicinesReport =
  async (req, res) => {
    try {
      const result =
        await getBestSellingMedicinesReportService();
