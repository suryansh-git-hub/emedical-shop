  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="flex min-h-screen items-center justify-center px-4 py-10">
        <div className="grid w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-2xl dark:border dark:border-slate-800 dark:bg-slate-900 dark:shadow-none lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/15 backdrop-blur-sm">
                  <Pill size={27} strokeWidth={2} />
                </div>
                <div>
                  <h1 className="text-xl font-bold">eMedi Pharmacy</h1>
                  <p className="text-sm text-blue-100">Online Pharmacy</p>
                </div>
              </div>
              ...
              <div className="mt-24">
                ...
                <p className="mt-5 max-w-md leading-7 text-blue-100">
                  Manage medicines, inventory, customers, purchases and billing from one simple platform.
                </p>
              </div>
            </div>
          ...
          <div className="p-6 sm:p-10 lg:p-12">
            ...
            <div className="mb-8 flex items-center justify-center gap-3 lg:hidden">
              ...
              <div>
                <h1 className="font-bold text-gray-900 dark:text-white">Medical Shop</h1>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className={`w-full rounded-xl border bg-gray-50 py-3 pl-10 pr-4 text-sm text-slate-900 placeholder:text-slate-400 outline-none transition focus:bg-white focus:ring-2 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder:text-slate-500 dark:focus:bg-slate-800 ${
                      errors.email
                        ? "border-red-400 focus:border-red-500 focus:ring-red-100 dark:focus:ring-red-950"
                        : "border-gray-200 focus:border-blue-500 focus:ring-blue-100 dark:focus:border-blue-500 dark:focus:ring-blue-950"
                    }`}
                    {...register("email", {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border bg-gray-50 py-3 pl-10 pr-12 text-sm text-slate-900 placeholder:text-slate-400 outline-none transition focus:bg-white focus:ring-2 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder:text-slate-500 dark:focus:bg-slate-800 ${
                      errors.password
                        ? "border-red-400 focus:border-red-500 focus:ring-red-100 dark:focus:ring-red-950"
                        : "border-gray-200 focus:border-blue-500 focus:ring-blue-100 dark:focus:border-blue-500 dark:focus:ring-blue-950"
                    }`}
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 transition hover:text-gray-700 dark:text-slate-400 dark:hover:text-slate-200"
